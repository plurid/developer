...
const Head: React.FC<HeadProperties> = (
    ...
    const titleValue = title || `developer`;
    const descriptionValue = description || 'Centralized Local Transpiler/Bundler/Linter/Tester';
    const ogTitleValue = ogTitle || title || `developer`;
    const ogDescriptionValue = ogDescription || description || 'Centralized Local Transpiler/Bundler/Linter/Tester';
